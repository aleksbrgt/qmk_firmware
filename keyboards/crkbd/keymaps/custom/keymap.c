...
enum custom_layers {
    ...
    MED, // Media keys
    FUN, // Function keys 
    OTH  // "Other", CAPS and RCTRL (RCTL is supposed ot be used as the compose key https://en.wikipedia.org/wiki/Compose_key)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //                                   -------+-------+-------      -------+-------+-------
    ...
    XXXXXXX, KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           XXXXXXX,           XXXXXXX,           KC_F4,             KC_F5,             KC_F6,             XXXXXXX,              XXXXXXX,
